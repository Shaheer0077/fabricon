        ...
        <nav className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-100 shadow-sm">
            <div className="max-w-[1280px] mx-auto h-20 flex items-center justify-between px-6 md:px-12 lg:px-20">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button className="hidden sm:flex items-center gap-2 bg-slate-900 hover:bg-black text-white px-6 py-3 rounded-2xl text-[11px] font-black uppercase tracking-widest transition-all transform active:scale-95 shadow-xl shadow-slate-200">
                        Sign In
                    </button>
                </div>
            </div>
