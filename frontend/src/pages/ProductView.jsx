                                    ...
                                    <div className="flex gap-3">
                                        {product.colors.map((color, i) => (
                                            <button
                                                ...
                                                className={`w-12 h-12 rounded-xl border-2 transition-all flex items-center justify-center shadow-sm ${selectedColor === i ? 'border-[#ff4d00] scale-110' : 'border-transparent hover:border-slate-200'
                                                    }`}
                                                style={{ backgroundColor: color }}
                                            >
                                                {selectedColor === i && (
                                                    <Check size={20} className={color === '#ffffff' ? 'text-slate-900' : 'text-white'} />
                                                )}
                                            </button>
                                        ))}
                                    </div>
                        ...
                        <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 mb-10">
                            <div className="flex items-center justify-between mb-6">
                                <div>
                                    ...
                                    <h3 className="text-4xl font-black text-slate-900">${product.price?.toFixed(2)}</h3>
                                </div>
