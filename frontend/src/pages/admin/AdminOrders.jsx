                                            ...
                                            {filteredOrders.map((order) => (
                                                ...
                                                >
                                                    <td className="px-10 py-5">
                                                        <span className="font-mono text-[11px] font-bold text-slate-400 group-hover:text-slate-900 transition-colors">#{order._id.slice(-8).toUpperCase()}</span>
                                                    </td>
                                                    <td className="px-10 py-5">
                                                    ...
                                                    <td className="px-10 py-5 text-center">
                                                        <span className="text-sm font-black text-slate-900 tracking-tight">${order.totalPrice.toFixed(2)}</span>
                                                    </td>
                                                    <td className="px-10 py-5 text-center">
                        ...
                        >
                            ...
                            <div className="px-10 py-8 bg-slate-50 border-b border-slate-100 flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h2 className="text-xl font-black text-slate-900 uppercase tracking-tight">Order #{selectedOrder._id.slice(-8).toUpperCase()}</h2>
                                    ...
                                    <div className="p-8 bg-slate-900 rounded-[2rem] text-white">
                                        <div className="flex justify-between items-end">
                                            <div>
                                                ...
                                                <p className="text-4xl font-black tracking-tighter">${selectedOrder.totalPrice.toFixed(2)}</p>
                                            </div>
