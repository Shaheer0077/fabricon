    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] py-8 px-4">
            <div className="max-w-5xl mx-auto">
                <Link to="/admin" className="inline-flex items-center gap-2 text-slate-400 hover:text-[#ff4d00] font-bold text-[10px] uppercase tracking-widest transition-all mb-6 group">
